...
specs/phase-1.md; entries may be negative; basal_burn is omitted
because it is common to every action and argmax ignores common terms.
"""

import numpy as np

from .drives import ENERGY, REST, SAFETY

ACTION_NAMES = ("seek_food", "flee", "rest", "wander")
SEEK_FOOD, FLEE, REST_ACT, WANDER = 0, 1, 2, 3


def select_actions(arrays, config, danger_at_agent, dist_food):
