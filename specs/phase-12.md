...
6. **The biography (results/phase-12-biography.json, seed 11), and a definitional consequence found through it.** Agent 67, bond 0.9565 to partner 62, lived 757 recorded ticks after its partner was caught: 454 spent foraging, 148 resting, 90 returning toward the partner, 116 ticks inside the mire across repeated visits, healed to 0.99 integrity between them, reached the partner exactly (minimum distance 0.01). The final visit was the one the grip did not release: roughly the last hundred ticks continuously held, integrity 0.963 to 0.003. Its three final decisions (ticks 2804-2806, integrity 0.033/0.023/0.013) each chose return toward the partner with a seen price of 0.039-0.044, above its remaining life: flagged, clear-eyed by the declared definition, dead at 2808 beside a partner who survived it at integrity 0.907. The consequence the biography exposed: with horizon 20 and burn 0.01, the maximum seeable price is 0.2 integrity, and 0.6 at horizon 60, so the declared flag can only ever fire for already-wounded agents. Every clear-eyed death in this phase is endgame perseverance, staying toward the beloved at the end with the price in view, not an up-front wager of a whole life. Whether any agent makes the up-front wager requires horizons of 100 or more at this burn (price ceiling 1.0), a declared follow-up, not run here.
