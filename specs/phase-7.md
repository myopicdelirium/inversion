...
5. **Replication, pre-declared, fresh seeds (2026-07-23, results/phase-7-replication.json).** Expectations declared before running: boundary monotone with survival below 0.3 by kappa 1 (measured 0.971/0.749/0.657/0.436/0.176/0.035/0.000/0.001 on seeds 11-15); zero neglect at kappa 0 and at least 5% of bereaved at kappa 2 with baseline at most 1% (measured 0/53 pooled at kappa 0; 59/559 and 52/622 at kappa 2, baselines 0.000, seeds 11-16); symmetry ratio at least 3 (measured 16.7, seeds 11-15). Every phase 7 pattern replicates under a declared design; the kappa 2 neglect rates run somewhat below the original cohort (0.106 and 0.084 versus 0.142 and 0.141), ordinary seed variation on large cohorts.
6. **The golden's character, stated plainly**: the frozen kappa 2 storm run ends with 0 of 400 alive at tick 3500. In the imprisoning regime, the storm's aftermath of locked dominances (grief, fear, hunger, each deaf to the others' worlds) collapses the whole population over the longer horizon. It is committed as the specimen of that regime.
